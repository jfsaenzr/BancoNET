...
<body>
    ...
    <ul class="nav nav-pills mb-3 row" id="pills-tab" role="tablist">
        ...
        <li class="nav-item col-1" role="presentation">
            <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">Pagos</button>
        </li>
        ...
        <div class="col-3">
            <div class="row">
                <div class="col-10 nombreUsuario2">
                    ...
                    <div class="nombreUsuario"><?php echo "<text style='color:green;'>" . $row['persona'] . "</text>"; ?></div>
                </div>
                <div class="col-2 imgUsuario">
                    <img src="img/perfil.png" height="50" class="btn btn-link dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <table class="table table-light table-hover text-center">
                        ...
                        $conexion = conectar();
                        $iduser = $_SESSION['usuario'];
                        $sql = "SELECT * FROM usuarios WHERE numero_ident ='$iduser' AND saldo > 0";
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <form id="frmActualizar" action="actualizarPago.php" method="post">
                                        <button class="btn btn-warning" id="btnActualizar" value="<?php echo $mostrar['id'] ?>" name=" id">Pagar</button>
                                    </form>
                                </td>
                            </tr>
                        <?php
                        ...
                        <tr>
                            ...
                            <td class="tdTitulo"></td>
                            <td class="tdTitulo"></td>
                            <td class="tdTitulo">Total a pagar</td>
                            <td class="tdTitulo"><?php echo  $total ?></td>
                            <td class="tdTitulo"></td>
                        </tr>
